...
The two examples, one of the 614th Tank Destroyer Battalion and the 477th Bombardment Group, have shown that as human you still add value in history. However, in time, these units will become common knowledge. This means that we will have to keep pushing against the boundaries of what's historically known.  
